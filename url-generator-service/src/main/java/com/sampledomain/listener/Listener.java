...
@Component
@KafkaListener(id = "listenerURLGenerator", topics = "${message.topic.url}")
public class Listener {
    @KafkaHandler
    public void handleSenderMessage(Message1 msg) {
        System.out.println("URLGenerator listener: Message1 received: " + msg.message());
    }

    @KafkaHandler
    public void handleReceiverMessage(Message2 msg) {
        System.out.println("URLGenerator listener: Message2 received: " + msg.message());
    }
